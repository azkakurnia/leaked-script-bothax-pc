Setting = {
    PNB = {
        WearItem = "Mythical Infinity Fist",
        ...
        WebhookURL = "https://discord.com/api/webhooks/1359949975349625023/93TaCiFeYOVUFnxZ2IKRAF7hP64UYFNRf1CIwcTiDIrvnyLXO2BN6Lt1Qx2KILfRYS76",
        WebhookDelay = 300
    },
				PosX = 0, -- Break Pos
				PosY = 0, -- Break Pos
...
AddHook("OnDraw", "Pro", function()
    local open = ImGui.Begin("Cheat PNB (Made by AwZka | @azkassasin)", true)
      ...
      "embeds": [
        {
          ...
          "color": 16711680,
          "thumbnail": {
            "url": "https://cdn.discordapp.com/attachments/1359017552965140533/1359747528307904592/ChatGPT_Image_Apr_8_2025_01_52_14_PM.png?ex=67fb3e11&is=67f9ec91&hm=366c90f6ba2c0f5bde316334c169b96ac8f3791fa1c0a870fd9e7c003d8200e8&"
          }
        }
      ]
    }
